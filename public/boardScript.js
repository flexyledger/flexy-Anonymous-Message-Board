$(function () {
  var currentBoard = window.location.pathname.split('/').pop()
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      data.forEach(function (ele) {
        ...
        thread.push('<h5>' + ele.replies.length + ' replies total (' + ele.hiddenCount + ' hidden)- <a href="' + window.location.pathname + '/' + ele._id + '">See the full thread here</a>.</h5>')
